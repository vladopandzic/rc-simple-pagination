...
describe('<Pagination/>', function () {
    ...
    it('should have at least one <li> with active class', function () {
        var wrapper = shallow(React.createElement(Pagination, { activePage: 5, numOfPages: 20, onPaginationNumberClicked: function () { }, nextLinkTitle: "Next", prevLinkTitle: "Prev" }));
    ...
    it('should render 14 <li>s (10+2 for back buttons +2 for forward buttons) when there are more than 10 pages', function () {
        var wrapper = shallow(React.createElement(Pagination, { activePage: 5, numOfPages: 340, onPaginationNumberClicked: function () { }, nextLinkTitle: "Next", prevLinkTitle: "Prev" }));
    ...
    it('should have "disabled" class on first page button when on first page or any page less than 10', function () {
        var wrapper = shallow(React.createElement(Pagination, { activePage: 1, numOfPages: 340, onPaginationNumberClicked: function () { }, nextLinkTitle: "Next", prevLinkTitle: "Prev" }));
        expect(wrapper.find('li').at(0).hasClass('disabled')).to.equal(true);
        var wrapper2 = shallow(React.createElement(Pagination, { activePage: 9, numOfPages: 340, onPaginationNumberClicked: function () { }, nextLinkTitle: "Next", prevLinkTitle: "Prev" }));
        expect(wrapper2.find('li').at(0).hasClass('disabled')).to.equal(true);
        var wrapper3 = shallow(React.createElement(Pagination, { activePage: 11, numOfPages: 340, onPaginationNumberClicked: function () { }, nextLinkTitle: "Next", prevLinkTitle: "Prev" }));
    ...
    it('should have "disabled" class on forward button when on last page', function () {
        var wrapper = shallow(React.createElement(Pagination, { activePage: 340, numOfPages: 340, onPaginationNumberClicked: function () { }, nextLinkTitle: "Next", prevLinkTitle: "Prev" }));
