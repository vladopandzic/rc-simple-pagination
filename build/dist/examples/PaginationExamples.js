...
var PaginationExamples = (function (_super) {
    ...
    PaginationExamples.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(Pagination_1.default, { activePage: this.state.currentPage, numOfPages: 30, onPaginationNumberClicked: this.onNumberClicked, nextLinkTitle: "Next", prevLinkTitle: "Prev" }),
            ...
            React.createElement("div", null,
                "Events:",
                React.createElement("ul", null, this.state.events.map(function (e) {
...
$(document).ready(function () {
    ReactDOM.render(React.createElement(PaginationExamples, null), document.getElementById('root'));
});
//# sourceMappingURL=PaginationExamples.js.map